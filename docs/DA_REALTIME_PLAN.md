...
- **⑯ P0-3 증거 artifact 합격 — v9.2 pathology-stress 실행** (2026-07-12,
  ...
  8.2e-4 kg/kg, ratio [0.95, 1.18]. **v9.1 대비의 교훈**: v9.1의 J −42%는
  qi ratio 4e11의 비물리 증분으로 산 것 — Huber+운영 게이트 하의 완만한
  −3.6%가 정직한 수렴임을 대비로 실증. 4-regime: 맑음/맑음 ±0.0%
  (Δq≈0 건전), **맑음/구름 +2.3% & dqtot_slot=+6.4e-6 — pseudo-RH 생성
  경로의 전 도메인 작동 실증**, 구름/구름 +4.5%, 구름/맑음 +7.1%
  (제거 방향). 재현성: manifest에 code SHA(53d323a)·명령·입력/출력
