...
PreambleOutputs preamble(
    ...
    progb::ProgBOutputs* progb_ret = nullptr  // §53d in/out persistent ProgB arrays (F:973-990 init + active-only writes); merged into .progb + slope inputs
);
...
RebuiltDiagnostics rebuild_aux(
    ...
    progb::ProgBOutputs* progb_ret = nullptr  // §53d threaded to preamble's persistent-ProgB merge
);
