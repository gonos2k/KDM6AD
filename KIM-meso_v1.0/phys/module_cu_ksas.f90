...
CONTAINS
   ...
   subroutine cu_ksas(dt,dx,p3di,p3d,pi3d,qc3d,qi3d,rho3d,itimestep,stepcu,    &
                     ...
                     its,ite, jts,jte, kts,kte, sigma, thre)
   ...
   do j = jts,jte
     ...
     call nsas2d(delt=delt,delx=dx,del=del(its,kts),                           &
              ...
              its=its,ite=ite, jts=jts,jte=jte, kts=kts,kte=kte, sigma=sigma,  &
              thre=thre  )
