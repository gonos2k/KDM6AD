...
IF ( setinitval .EQ. 3 ) grid%fogvis_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_vis_thr_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_rh0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_drh=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_qc0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_dqc=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_u0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_du=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_c_contrast=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_beta_min=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_vis_max_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_vis_soft_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_a_clw=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_b_clw=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_beta_aer=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_zeff_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_scale_h_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_top_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_pblh_mult=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_aod_pblh_default_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_sigma_min=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_alpha_sig=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_ust_ref=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_sea_mode=0
IF ( setinitval .EQ. 3 ) grid%fogvis_rh0_sea=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_qc0_sea=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_u0_sea=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_a_clw_sea_mult=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_beta_aer_sea=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_ext_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_a_rain=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_b_rain=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_a_snow=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_b_snow=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_a_ice=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_b_ice=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_a_grau=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_b_grau=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_land_cm3=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_sea_cm3=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_ref_cm3=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_gamma=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_sigma_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_hfx0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_dhfx=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_alpha_hfx=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_pblh0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_alpha_pblh=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_qfx0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_dqfx=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_alpha_qfx=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_sigma_sea_mult=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_vlayer_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_base_max_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_top_max_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_ff_floor_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_ff_floor=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_entrain_opt=0
IF ( setinitval .EQ. 3 ) grid%fogvis_top_pen_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_top_pen_scale_m=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_pen_u0=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_pen_du=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_nd_src=0
IF ( setinitval .EQ. 3 ) grid%fogvis_qext=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_rho_w=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_re_mult=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_re_min_um=initial_data_value
IF ( setinitval .EQ. 3 ) grid%fogvis_re_max_um=initial_data_value
IF(okay_to_alloc.AND.in_use_for_config(id,'vis_sfc').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%vis_sfc(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",309,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%vis_sfc=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'vis_sfc'
  grid%tail_statevars%DataName = 'VIS_SFC'
  grid%tail_statevars%Description = 'Surface visibility diagnostic'
  ...
  grid%tail_statevars%rfield_2d => grid%vis_sfc
  ...
  ENDIF
ELSE
  ALLOCATE(grid%vis_sfc(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",359,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'vis_sfc_raw').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%vis_sfc_raw(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",371,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc_raw(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%vis_sfc_raw=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'vis_sfc_raw'
  grid%tail_statevars%DataName = 'VIS_SFC_RAW'
  grid%tail_statevars%Description = 'Surface visibility (raw, no max cap)'
  grid%tail_statevars%Units = 'm'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%vis_sfc_raw
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%vis_sfc_raw(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",421,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc_raw(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'vis_sfc_capped').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%vis_sfc_capped(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",433,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc_capped(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%vis_sfc_capped=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'vis_sfc_capped'
  grid%tail_statevars%DataName = 'VIS_SFC_CAPPED'
  grid%tail_statevars%Description = 'VIS_SFC exceeded max cap (1=yes)'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%vis_sfc_capped
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%vis_sfc_capped(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",483,&
    'frame/module_domain.f: Failed to allocate grid%vis_sfc_capped(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'fogfrac_sfc').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%fogfrac_sfc(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",495,&
    'frame/module_domain.f: Failed to allocate grid%fogfrac_sfc(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%fogfrac_sfc=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'fogfrac_sfc'
  grid%tail_statevars%DataName = 'FOGFRAC_SFC'
  grid%tail_statevars%Description = 'Fog fraction: subgrid fraction with VIS<thr'
  grid%tail_statevars%Units = '1'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%fogfrac_sfc
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%fogfrac_sfc(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",545,&
    'frame/module_domain.f: Failed to allocate grid%fogfrac_sfc(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'fogmask').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%fogmask(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",557,&
    'frame/module_domain.f: Failed to allocate grid%fogmask(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%fogmask=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'fogmask'
  grid%tail_statevars%DataName = 'FOG_MASK'
  grid%tail_statevars%Description = 'Deterministic surface-based fog mask'
  grid%tail_statevars%Units = '1'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%fogmask
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%fogmask(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",607,&
    'frame/module_domain.f: Failed to allocate grid%fogmask(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'fogbase_m').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%fogbase_m(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",619,&
    'frame/module_domain.f: Failed to allocate grid%fogbase_m(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%fogbase_m=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'fogbase_m'
  grid%tail_statevars%DataName = 'FOGBASE_M'
  grid%tail_statevars%Description = 'Fog base height AGL'
  grid%tail_statevars%Units = 'm'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%fogbase_m
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%fogbase_m(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",669,&
    'frame/module_domain.f: Failed to allocate grid%fogbase_m(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'fogtop_m').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%fogtop_m(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",681,&
    'frame/module_domain.f: Failed to allocate grid%fogtop_m(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%fogtop_m=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'fogtop_m'
  grid%tail_statevars%DataName = 'FOGTOP_M'
  grid%tail_statevars%Description = 'Fog top height AGL'
  grid%tail_statevars%Units = 'm'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%fogtop_m
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%fogtop_m(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",731,&
    'frame/module_domain.f: Failed to allocate grid%fogtop_m(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'fogdepth_m').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%fogdepth_m(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",743,&
    'frame/module_domain.f: Failed to allocate grid%fogdepth_m(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%fogdepth_m=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'fogdepth_m'
  grid%tail_statevars%DataName = 'FOGDEPTH_M'
  grid%tail_statevars%Description = 'Fog depth'
  grid%tail_statevars%Units = 'm'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%fogdepth_m
  grid%tail_statevars%streams(1) = 1 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%fogdepth_m(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",793,&
    'frame/module_domain.f: Failed to allocate grid%fogdepth_m(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'betaext_sfc').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%betaext_sfc(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",805,&
    'frame/module_domain.f: Failed to allocate grid%betaext_sfc(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%betaext_sfc=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'betaext_sfc'
  grid%tail_statevars%DataName = 'BETAEXT_SFC'
  grid%tail_statevars%Description = 'Total extinction coefficient at sfc'
  grid%tail_statevars%Units = '1/m'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  grid%tail_statevars%Stagger      = ''
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%betaext_sfc
  ...
  ENDIF
ELSE
  ALLOCATE(grid%betaext_sfc(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",855,&
    'frame/module_domain.f: Failed to allocate grid%betaext_sfc(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'lwc_sfc_gm3').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%lwc_sfc_gm3(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",867,&
    'frame/module_domain.f: Failed to allocate grid%lwc_sfc_gm3(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%lwc_sfc_gm3=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'lwc_sfc_gm3'
  grid%tail_statevars%DataName = 'LWC_SFC_GM3'
  grid%tail_statevars%Description = 'Cloud liquid water content at sfc'
  grid%tail_statevars%Units = 'g/m3'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  grid%tail_statevars%Stagger      = ''
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%lwc_sfc_gm3
  grid%tail_statevars%streams(1) = 0 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%lwc_sfc_gm3(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",917,&
    'frame/module_domain.f: Failed to allocate grid%lwc_sfc_gm3(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'nd_sfc_cm3').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%nd_sfc_cm3(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",929,&
    'frame/module_domain.f: Failed to allocate grid%nd_sfc_cm3(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%nd_sfc_cm3=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'nd_sfc_cm3'
  grid%tail_statevars%DataName = 'ND_SFC_CM3'
  grid%tail_statevars%Description = 'Droplet number at sfc (from qnc)'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%nd_sfc_cm3
  grid%tail_statevars%streams(1) = 0 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%nd_sfc_cm3(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",979,&
    'frame/module_domain.f: Failed to allocate grid%nd_sfc_cm3(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'re_sfc_um').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%re_sfc_um(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",991,&
    'frame/module_domain.f: Failed to allocate grid%re_sfc_um(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%re_sfc_um=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 're_sfc_um'
  grid%tail_statevars%DataName = 'RE_SFC_UM'
  grid%tail_statevars%Description = 'Effective radius at sfc (from LWC+Nc)'
  ...
  grid%tail_statevars%Restart  = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%re_sfc_um
  grid%tail_statevars%streams(1) = 0 
  grid%tail_statevars%streams(2) = 0 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%re_sfc_um(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",1041,&
    'frame/module_domain.f: Failed to allocate grid%re_sfc_um(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'aod_sfc').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%aod_sfc(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",1053,&
    'frame/module_domain.f: Failed to allocate grid%aod_sfc(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%aod_sfc=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'aod_sfc'
  grid%tail_statevars%DataName = 'AOD_SFC'
  grid%tail_statevars%Description = 'Aerosol optical depth (input for fogvis)'
  ...
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%aod_sfc
  ...
  ENDIF
ELSE
  ALLOCATE(grid%aod_sfc(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",1103,&
    'frame/module_domain.f: Failed to allocate grid%aod_sfc(1,1).  ')
  endif
ENDIF
IF(okay_to_alloc.AND.in_use_for_config(id,'beta_aer_sfc').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  nba = &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4

  ALLOCATE(grid%beta_aer_sfc(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",1115,&
    'frame/module_domain.f: Failed to allocate grid%beta_aer_sfc(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%beta_aer_sfc=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'beta_aer_sfc'
  grid%tail_statevars%DataName = 'BETA_AER_SFC'
  grid%tail_statevars%Description = 'Aerosol extinction coefficient at sfc (external)'
  grid%tail_statevars%Units = '1/m'
  grid%tail_statevars%Type    = 'r'
  grid%tail_statevars%ProcOrient    = ' '
  grid%tail_statevars%MemoryOrder  = 'XY'
  ...
  grid%tail_statevars%Restart  = .TRUE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%beta_aer_sfc
  grid%tail_statevars%streams(1) = 33554433 
  grid%tail_statevars%streams(2) = 2097152 
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%beta_aer_sfc(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",1165,&
    'frame/module_domain.f: Failed to allocate grid%beta_aer_sfc(1,1).  ')
  endif
ENDIF
...
IF ( setinitval .EQ. 3 ) grid%scale_h=initial_data_value
