...
integer :: nssl_icdx
integer :: nssl_icdxhl
integer , DIMENSION(max_domains) :: nssl_hail_on
integer :: nssl_ccn_on
...
real , DIMENSION(max_domains) :: sigma
real , DIMENSION(max_domains) :: thre
real , DIMENSION(max_domains) :: ncmin_land
real , DIMENSION(max_domains) :: ncmin_sea
integer :: isfflx
integer :: ifsnow
integer :: icloud
integer :: cldovrlp
...
integer , DIMENSION(max_domains) :: tree_canopy
real , DIMENSION(max_domains) :: tree_canopy_alpha
...
integer , DIMENSION(max_domains) :: fogvis_opt
real , DIMENSION(max_domains) :: fogvis_vis_thr_m
real , DIMENSION(max_domains) :: fogvis_rh0
real , DIMENSION(max_domains) :: fogvis_drh
real , DIMENSION(max_domains) :: fogvis_qc0
real , DIMENSION(max_domains) :: fogvis_dqc
real , DIMENSION(max_domains) :: fogvis_u0
real , DIMENSION(max_domains) :: fogvis_du
real , DIMENSION(max_domains) :: fogvis_c_contrast
real , DIMENSION(max_domains) :: fogvis_beta_min
real , DIMENSION(max_domains) :: fogvis_vis_max_m
real , DIMENSION(max_domains) :: fogvis_vis_soft_m
real , DIMENSION(max_domains) :: fogvis_a_clw
real , DIMENSION(max_domains) :: fogvis_b_clw
real , DIMENSION(max_domains) :: fogvis_beta_aer
integer , DIMENSION(max_domains) :: fogvis_aod_opt
real , DIMENSION(max_domains) :: fogvis_aod_zeff_m
real , DIMENSION(max_domains) :: fogvis_aod_scale_h_m
real , DIMENSION(max_domains) :: fogvis_aod_top_m
real , DIMENSION(max_domains) :: fogvis_aod_pblh_mult
real , DIMENSION(max_domains) :: fogvis_aod_pblh_default_m
real , DIMENSION(max_domains) :: fogvis_sigma_min
real , DIMENSION(max_domains) :: fogvis_alpha_sig
real , DIMENSION(max_domains) :: fogvis_ust_ref
integer , DIMENSION(max_domains) :: fogvis_sea_mode
real , DIMENSION(max_domains) :: fogvis_rh0_sea
real , DIMENSION(max_domains) :: fogvis_qc0_sea
real , DIMENSION(max_domains) :: fogvis_u0_sea
real , DIMENSION(max_domains) :: fogvis_a_clw_sea_mult
real , DIMENSION(max_domains) :: fogvis_beta_aer_sea
integer , DIMENSION(max_domains) :: fogvis_ext_opt
real , DIMENSION(max_domains) :: fogvis_a_rain
real , DIMENSION(max_domains) :: fogvis_b_rain
real , DIMENSION(max_domains) :: fogvis_a_snow
real , DIMENSION(max_domains) :: fogvis_b_snow
real , DIMENSION(max_domains) :: fogvis_a_ice
real , DIMENSION(max_domains) :: fogvis_b_ice
real , DIMENSION(max_domains) :: fogvis_a_grau
real , DIMENSION(max_domains) :: fogvis_b_grau
integer , DIMENSION(max_domains) :: fogvis_nd_opt
real , DIMENSION(max_domains) :: fogvis_nd_land_cm3
real , DIMENSION(max_domains) :: fogvis_nd_sea_cm3
real , DIMENSION(max_domains) :: fogvis_nd_ref_cm3
real , DIMENSION(max_domains) :: fogvis_nd_gamma
integer , DIMENSION(max_domains) :: fogvis_sigma_opt
real , DIMENSION(max_domains) :: fogvis_hfx0
real , DIMENSION(max_domains) :: fogvis_dhfx
real , DIMENSION(max_domains) :: fogvis_alpha_hfx
real , DIMENSION(max_domains) :: fogvis_pblh0
real , DIMENSION(max_domains) :: fogvis_alpha_pblh
real , DIMENSION(max_domains) :: fogvis_qfx0
real , DIMENSION(max_domains) :: fogvis_dqfx
real , DIMENSION(max_domains) :: fogvis_alpha_qfx
real , DIMENSION(max_domains) :: fogvis_sigma_sea_mult
integer , DIMENSION(max_domains) :: fogvis_vlayer_opt
real , DIMENSION(max_domains) :: fogvis_base_max_m
real , DIMENSION(max_domains) :: fogvis_top_max_m
integer , DIMENSION(max_domains) :: fogvis_ff_floor_opt
real , DIMENSION(max_domains) :: fogvis_ff_floor
integer , DIMENSION(max_domains) :: fogvis_entrain_opt
real , DIMENSION(max_domains) :: fogvis_top_pen_m
real , DIMENSION(max_domains) :: fogvis_top_pen_scale_m
real , DIMENSION(max_domains) :: fogvis_pen_u0
real , DIMENSION(max_domains) :: fogvis_pen_du
integer , DIMENSION(max_domains) :: fogvis_nd_src
real , DIMENSION(max_domains) :: fogvis_qext
real , DIMENSION(max_domains) :: fogvis_rho_w
real , DIMENSION(max_domains) :: fogvis_re_mult
real , DIMENSION(max_domains) :: fogvis_re_min_um
real , DIMENSION(max_domains) :: fogvis_re_max_um
...
NAMELIST /physics/ thre
NAMELIST /physics/ ncmin_land
NAMELIST /physics/ ncmin_sea
...
NAMELIST /physics/ tree_canopy
NAMELIST /physics/ tree_canopy_alpha
...
NAMELIST /physics/ charnock_update
...
NAMELIST /physics/ fogvis_opt
NAMELIST /physics/ fogvis_vis_thr_m
NAMELIST /physics/ fogvis_rh0
NAMELIST /physics/ fogvis_drh
NAMELIST /physics/ fogvis_qc0
NAMELIST /physics/ fogvis_dqc
NAMELIST /physics/ fogvis_u0
NAMELIST /physics/ fogvis_du
NAMELIST /physics/ fogvis_c_contrast
NAMELIST /physics/ fogvis_beta_min
NAMELIST /physics/ fogvis_vis_max_m
NAMELIST /physics/ fogvis_vis_soft_m
NAMELIST /physics/ fogvis_a_clw
NAMELIST /physics/ fogvis_b_clw
NAMELIST /physics/ fogvis_beta_aer
NAMELIST /physics/ fogvis_aod_opt
NAMELIST /physics/ fogvis_aod_zeff_m
NAMELIST /physics/ fogvis_aod_scale_h_m
NAMELIST /physics/ fogvis_aod_top_m
NAMELIST /physics/ fogvis_aod_pblh_mult
NAMELIST /physics/ fogvis_aod_pblh_default_m
NAMELIST /physics/ fogvis_sigma_min
NAMELIST /physics/ fogvis_alpha_sig
NAMELIST /physics/ fogvis_ust_ref
NAMELIST /physics/ fogvis_sea_mode
NAMELIST /physics/ fogvis_rh0_sea
NAMELIST /physics/ fogvis_qc0_sea
NAMELIST /physics/ fogvis_u0_sea
NAMELIST /physics/ fogvis_a_clw_sea_mult
NAMELIST /physics/ fogvis_beta_aer_sea
NAMELIST /physics/ fogvis_ext_opt
NAMELIST /physics/ fogvis_a_rain
NAMELIST /physics/ fogvis_b_rain
NAMELIST /physics/ fogvis_a_snow
NAMELIST /physics/ fogvis_b_snow
NAMELIST /physics/ fogvis_a_ice
NAMELIST /physics/ fogvis_b_ice
NAMELIST /physics/ fogvis_a_grau
NAMELIST /physics/ fogvis_b_grau
NAMELIST /physics/ fogvis_nd_opt
NAMELIST /physics/ fogvis_nd_land_cm3
NAMELIST /physics/ fogvis_nd_sea_cm3
NAMELIST /physics/ fogvis_nd_ref_cm3
NAMELIST /physics/ fogvis_nd_gamma
NAMELIST /physics/ fogvis_sigma_opt
NAMELIST /physics/ fogvis_hfx0
NAMELIST /physics/ fogvis_dhfx
NAMELIST /physics/ fogvis_alpha_hfx
NAMELIST /physics/ fogvis_pblh0
NAMELIST /physics/ fogvis_alpha_pblh
NAMELIST /physics/ fogvis_qfx0
NAMELIST /physics/ fogvis_dqfx
NAMELIST /physics/ fogvis_alpha_qfx
NAMELIST /physics/ fogvis_sigma_sea_mult
NAMELIST /physics/ fogvis_vlayer_opt
NAMELIST /physics/ fogvis_base_max_m
NAMELIST /physics/ fogvis_top_max_m
NAMELIST /physics/ fogvis_ff_floor_opt
NAMELIST /physics/ fogvis_ff_floor
NAMELIST /physics/ fogvis_entrain_opt
NAMELIST /physics/ fogvis_top_pen_m
NAMELIST /physics/ fogvis_top_pen_scale_m
NAMELIST /physics/ fogvis_pen_u0
NAMELIST /physics/ fogvis_pen_du
NAMELIST /physics/ fogvis_nd_src
NAMELIST /physics/ fogvis_qext
NAMELIST /physics/ fogvis_rho_w
NAMELIST /physics/ fogvis_re_mult
NAMELIST /physics/ fogvis_re_min_um
NAMELIST /physics/ fogvis_re_max_um
