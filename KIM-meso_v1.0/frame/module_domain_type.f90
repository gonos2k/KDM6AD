...
real                                     :: fogvis_u0
real                                     :: fogvis_du
real                                     :: fogvis_c_contrast
real                                     :: fogvis_beta_min
real                                     :: fogvis_vis_max_m
real                                     :: fogvis_vis_soft_m
real                                     :: fogvis_a_clw
real                                     :: fogvis_b_clw
real                                     :: fogvis_beta_aer
integer                                  :: fogvis_aod_opt
real                                     :: fogvis_aod_zeff_m
real                                     :: fogvis_aod_scale_h_m
real                                     :: fogvis_aod_top_m
real                                     :: fogvis_aod_pblh_mult
real                                     :: fogvis_aod_pblh_default_m
real                                     :: fogvis_sigma_min
real                                     :: fogvis_alpha_sig
real                                     :: fogvis_ust_ref
integer                                  :: fogvis_sea_mode
real                                     :: fogvis_rh0_sea
real                                     :: fogvis_qc0_sea
real                                     :: fogvis_u0_sea
real                                     :: fogvis_a_clw_sea_mult
real                                     :: fogvis_beta_aer_sea
integer                                  :: fogvis_ext_opt
real                                     :: fogvis_a_rain
real                                     :: fogvis_b_rain
real                                     :: fogvis_a_snow
real                                     :: fogvis_b_snow
...
real                                     :: fogvis_a_grau
real                                     :: fogvis_b_grau
integer                                  :: fogvis_nd_opt
real                                     :: fogvis_nd_land_cm3
real                                     :: fogvis_nd_sea_cm3
real                                     :: fogvis_nd_ref_cm3
real                                     :: fogvis_nd_gamma
integer                                  :: fogvis_sigma_opt
real                                     :: fogvis_hfx0
real                                     :: fogvis_dhfx
real                                     :: fogvis_alpha_hfx
real                                     :: fogvis_pblh0
real                                     :: fogvis_alpha_pblh
real                                     :: fogvis_qfx0
real                                     :: fogvis_dqfx
real                                     :: fogvis_alpha_qfx
real                                     :: fogvis_sigma_sea_mult
integer                                  :: fogvis_vlayer_opt
real                                     :: fogvis_base_max_m
real                                     :: fogvis_top_max_m
integer                                  :: fogvis_ff_floor_opt
real                                     :: fogvis_ff_floor
integer                                  :: fogvis_entrain_opt
real                                     :: fogvis_top_pen_m
real                                     :: fogvis_top_pen_scale_m
real                                     :: fogvis_pen_u0
real                                     :: fogvis_pen_du
integer                                  :: fogvis_nd_src
real                                     :: fogvis_qext
real                                     :: fogvis_rho_w
real                                     :: fogvis_re_mult
real                                     :: fogvis_re_min_um
real                                     :: fogvis_re_max_um
real                                     :: sas_pgcon
...
real      ,DIMENSION(:,:)     ,POINTER   :: u80
real      ,DIMENSION(:,:)     ,POINTER   :: u140
real      ,DIMENSION(:,:)     ,POINTER   :: u220
real      ,DIMENSION(:,:)     ,POINTER   :: v10
real      ,DIMENSION(:,:)     ,POINTER   :: v80
real      ,DIMENSION(:,:)     ,POINTER   :: v140
real      ,DIMENSION(:,:)     ,POINTER   :: v220
...
real      ,DIMENSION(:,:)     ,POINTER   :: tree_hgt
real      ,DIMENSION(:,:)     ,POINTER   :: charnock
...
real      ,DIMENSION(:,:)     ,POINTER   :: refl_sfc
...
real      ,DIMENSION(:,:)     ,POINTER   :: chs_jun
real      ,DIMENSION(:,:)     ,POINTER   :: zol_jun
real      ,DIMENSION(:,:)     ,POINTER   :: br_jun
real      ,DIMENSION(:,:)     ,POINTER   :: psim_hat_jun
real      ,DIMENSION(:,:)     ,POINTER   :: psih_hat_jun
real      ,DIMENSION(:,:)     ,POINTER   :: psix_jun
real      ,DIMENSION(:,:)     ,POINTER   :: psiq_jun
real      ,DIMENSION(:,:)     ,POINTER   :: wspd_jun
real      ,DIMENSION(:,:)     ,POINTER   :: ust_jun
real      ,DIMENSION(:,:)     ,POINTER   :: hc_jun
real      ,DIMENSION(:,:)     ,POINTER   :: lc_jun
real      ,DIMENSION(:,:)     ,POINTER   :: chs_ori
real      ,DIMENSION(:,:)     ,POINTER   :: lai_jun
real      ,DIMENSION(:,:)     ,POINTER   :: beta_jun
real      ,DIMENSION(:,:)     ,POINTER   :: zpd_jun
...
real      ,DIMENSION(:,:)     ,POINTER   :: vis_sfc
real      ,DIMENSION(:,:)     ,POINTER   :: vis_sfc_raw
real      ,DIMENSION(:,:)     ,POINTER   :: vis_sfc_capped
real      ,DIMENSION(:,:)     ,POINTER   :: fogfrac_sfc
real      ,DIMENSION(:,:)     ,POINTER   :: fogmask
real      ,DIMENSION(:,:)     ,POINTER   :: fogbase_m
real      ,DIMENSION(:,:)     ,POINTER   :: fogtop_m
real      ,DIMENSION(:,:)     ,POINTER   :: fogdepth_m
real      ,DIMENSION(:,:)     ,POINTER   :: betaext_sfc
real      ,DIMENSION(:,:)     ,POINTER   :: lwc_sfc_gm3
real      ,DIMENSION(:,:)     ,POINTER   :: nd_sfc_cm3
real      ,DIMENSION(:,:)     ,POINTER   :: re_sfc_um
real      ,DIMENSION(:,:)     ,POINTER   :: aod_sfc
real      ,DIMENSION(:,:)     ,POINTER   :: beta_aer_sfc
