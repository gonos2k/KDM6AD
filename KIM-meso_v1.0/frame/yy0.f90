...
SUBROUTINE nl_get_nssl_hail_on ( id_id , nssl_hail_on )
  ...
  INTEGER id_id
  nssl_hail_on = model_config_rec%nssl_hail_on(id_id)
  RETURN
...
SUBROUTINE nl_get_thre ( id_id , thre )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: thre
  INTEGER id_id
  thre = model_config_rec%thre(id_id)
  RETURN
END SUBROUTINE nl_get_thre
SUBROUTINE nl_get_ncmin_land ( id_id , ncmin_land )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: ncmin_land
  INTEGER id_id
  ncmin_land = model_config_rec%ncmin_land(id_id)
  RETURN
END SUBROUTINE nl_get_ncmin_land
