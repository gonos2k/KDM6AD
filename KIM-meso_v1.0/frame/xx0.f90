...
SUBROUTINE nl_set_nssl_hail_on ( id_id , nssl_hail_on )
  ...
  INTEGER id_id
  model_config_rec%nssl_hail_on(id_id) = nssl_hail_on
  RETURN
...
SUBROUTINE nl_set_thre ( id_id , thre )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(IN) :: thre
  INTEGER id_id
  model_config_rec%thre(id_id) = thre
  RETURN
END SUBROUTINE nl_set_thre
SUBROUTINE nl_set_ncmin_land ( id_id , ncmin_land )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(IN) :: ncmin_land
  INTEGER id_id
  model_config_rec%ncmin_land(id_id) = ncmin_land
  RETURN
END SUBROUTINE nl_set_ncmin_land
