...
CONTAINS
   ...
   SUBROUTINE read_wps ( grid, filename, file_date_string, num_metgrid_levels )
      ...
      if (ierr /= 0) then
       call wrf_error_fatal3("module_wps_io_arw.b",276,&
"Error opening file with mpi io")
	...
	write(a_message,*) 'bad v_gc defined: ', I,K,J,grid%v_gc(I,K,J)
        CALL wrf_message ( a_message )            
	call wrf_error_fatal3("module_wps_io_arw.b",759,&
" bad v_gc")
	endif
         ENDDO
        ENDDO
	...
	write(a_message,*) 'bad u_gc defined: ', I,K,J,grid%u_gc(I,K,J)
        CALL wrf_message ( a_message )            
	call wrf_error_fatal3("module_wps_io_arw.b",778,&
" bad u_gc")
	endif
         ENDDO
        ENDDO
	...
	write(a_message,*) 'bad t_gc defined: ', I,K,J,grid%t_gc(I,K,J)
        CALL wrf_message ( a_message )            
	call wrf_error_fatal3("module_wps_io_arw.b",797,&
" bad t_gc")
	endif
         ENDDO
        ENDDO
...
890  continue
     ...
     CALL wrf_message ( a_message )               
     call wrf_error_fatal3("module_wps_io_arw.b",1732,&
...
890  continue
     ...
     close(in_unit)
     call wrf_error_fatal3("module_wps_io_arw.b",1905,&
"bad reclen stuff")
     return
