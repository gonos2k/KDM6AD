...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % nssl_hail_on               = model_config_rec % nssl_hail_on (grid%id)
 ...
 grid % thre                       = model_config_rec % thre (grid%id)
 grid % ncmin_land                 = model_config_rec % ncmin_land (grid%id)
 grid % ncmin_sea                  = model_config_rec % ncmin_sea (grid%id)
 ...
 grid % tree_canopy                = model_config_rec % tree_canopy (grid%id)
 grid % tree_canopy_alpha          = model_config_rec % tree_canopy_alpha (grid%id)
 ...
 grid % charnock_update            = model_config_rec % charnock_update 
 ...
 grid % fogvis_opt                 = model_config_rec % fogvis_opt (grid%id)
 grid % fogvis_vis_thr_m           = model_config_rec % fogvis_vis_thr_m (grid%id)
 grid % fogvis_rh0                 = model_config_rec % fogvis_rh0 (grid%id)
 grid % fogvis_drh                 = model_config_rec % fogvis_drh (grid%id)
 grid % fogvis_qc0                 = model_config_rec % fogvis_qc0 (grid%id)
 grid % fogvis_dqc                 = model_config_rec % fogvis_dqc (grid%id)
 grid % fogvis_u0                  = model_config_rec % fogvis_u0 (grid%id)
 grid % fogvis_du                  = model_config_rec % fogvis_du (grid%id)
 grid % fogvis_c_contrast          = model_config_rec % fogvis_c_contrast (grid%id)
 grid % fogvis_beta_min            = model_config_rec % fogvis_beta_min (grid%id)
 grid % fogvis_vis_max_m           = model_config_rec % fogvis_vis_max_m (grid%id)
 grid % fogvis_vis_soft_m          = model_config_rec % fogvis_vis_soft_m (grid%id)
 grid % fogvis_a_clw               = model_config_rec % fogvis_a_clw (grid%id)
 grid % fogvis_b_clw               = model_config_rec % fogvis_b_clw (grid%id)
 grid % fogvis_beta_aer            = model_config_rec % fogvis_beta_aer (grid%id)
 grid % fogvis_aod_opt             = model_config_rec % fogvis_aod_opt (grid%id)
 grid % fogvis_aod_zeff_m          = model_config_rec % fogvis_aod_zeff_m (grid%id)
 grid % fogvis_aod_scale_h_m       = model_config_rec % fogvis_aod_scale_h_m (grid%id)
 grid % fogvis_aod_top_m           = model_config_rec % fogvis_aod_top_m (grid%id)
 grid % fogvis_aod_pblh_mult       = model_config_rec % fogvis_aod_pblh_mult (grid%id)
 grid % fogvis_aod_pblh_default_m  = model_config_rec % fogvis_aod_pblh_default_m (grid%id)
 grid % fogvis_sigma_min           = model_config_rec % fogvis_sigma_min (grid%id)
 grid % fogvis_alpha_sig           = model_config_rec % fogvis_alpha_sig (grid%id)
 grid % fogvis_ust_ref             = model_config_rec % fogvis_ust_ref (grid%id)
 grid % fogvis_sea_mode            = model_config_rec % fogvis_sea_mode (grid%id)
 grid % fogvis_rh0_sea             = model_config_rec % fogvis_rh0_sea (grid%id)
 grid % fogvis_qc0_sea             = model_config_rec % fogvis_qc0_sea (grid%id)
 grid % fogvis_u0_sea              = model_config_rec % fogvis_u0_sea (grid%id)
 grid % fogvis_a_clw_sea_mult      = model_config_rec % fogvis_a_clw_sea_mult (grid%id)
 grid % fogvis_beta_aer_sea        = model_config_rec % fogvis_beta_aer_sea (grid%id)
 grid % fogvis_ext_opt             = model_config_rec % fogvis_ext_opt (grid%id)
 grid % fogvis_a_rain              = model_config_rec % fogvis_a_rain (grid%id)
 grid % fogvis_b_rain              = model_config_rec % fogvis_b_rain (grid%id)
 grid % fogvis_a_snow              = model_config_rec % fogvis_a_snow (grid%id)
 grid % fogvis_b_snow              = model_config_rec % fogvis_b_snow (grid%id)
 grid % fogvis_a_ice               = model_config_rec % fogvis_a_ice (grid%id)
 grid % fogvis_b_ice               = model_config_rec % fogvis_b_ice (grid%id)
 grid % fogvis_a_grau              = model_config_rec % fogvis_a_grau (grid%id)
 grid % fogvis_b_grau              = model_config_rec % fogvis_b_grau (grid%id)
 grid % fogvis_nd_opt              = model_config_rec % fogvis_nd_opt (grid%id)
 grid % fogvis_nd_land_cm3         = model_config_rec % fogvis_nd_land_cm3 (grid%id)
 grid % fogvis_nd_sea_cm3          = model_config_rec % fogvis_nd_sea_cm3 (grid%id)
 grid % fogvis_nd_ref_cm3          = model_config_rec % fogvis_nd_ref_cm3 (grid%id)
 grid % fogvis_nd_gamma            = model_config_rec % fogvis_nd_gamma (grid%id)
 grid % fogvis_sigma_opt           = model_config_rec % fogvis_sigma_opt (grid%id)
 grid % fogvis_hfx0                = model_config_rec % fogvis_hfx0 (grid%id)
 grid % fogvis_dhfx                = model_config_rec % fogvis_dhfx (grid%id)
 grid % fogvis_alpha_hfx           = model_config_rec % fogvis_alpha_hfx (grid%id)
 grid % fogvis_pblh0               = model_config_rec % fogvis_pblh0 (grid%id)
 grid % fogvis_alpha_pblh          = model_config_rec % fogvis_alpha_pblh (grid%id)
 grid % fogvis_qfx0                = model_config_rec % fogvis_qfx0 (grid%id)
 grid % fogvis_dqfx                = model_config_rec % fogvis_dqfx (grid%id)
 grid % fogvis_alpha_qfx           = model_config_rec % fogvis_alpha_qfx (grid%id)
 grid % fogvis_sigma_sea_mult      = model_config_rec % fogvis_sigma_sea_mult (grid%id)
 grid % fogvis_vlayer_opt          = model_config_rec % fogvis_vlayer_opt (grid%id)
 grid % fogvis_base_max_m          = model_config_rec % fogvis_base_max_m (grid%id)
 grid % fogvis_top_max_m           = model_config_rec % fogvis_top_max_m (grid%id)
 grid % fogvis_ff_floor_opt        = model_config_rec % fogvis_ff_floor_opt (grid%id)
 grid % fogvis_ff_floor            = model_config_rec % fogvis_ff_floor (grid%id)
 grid % fogvis_entrain_opt         = model_config_rec % fogvis_entrain_opt (grid%id)
 grid % fogvis_top_pen_m           = model_config_rec % fogvis_top_pen_m (grid%id)
 grid % fogvis_top_pen_scale_m     = model_config_rec % fogvis_top_pen_scale_m (grid%id)
 grid % fogvis_pen_u0              = model_config_rec % fogvis_pen_u0 (grid%id)
 grid % fogvis_pen_du              = model_config_rec % fogvis_pen_du (grid%id)
 grid % fogvis_nd_src              = model_config_rec % fogvis_nd_src (grid%id)
 grid % fogvis_qext                = model_config_rec % fogvis_qext (grid%id)
 grid % fogvis_rho_w               = model_config_rec % fogvis_rho_w (grid%id)
 grid % fogvis_re_mult             = model_config_rec % fogvis_re_mult (grid%id)
 grid % fogvis_re_min_um           = model_config_rec % fogvis_re_min_um (grid%id)
 grid % fogvis_re_max_um           = model_config_rec % fogvis_re_max_um (grid%id)
 ...
 grid % scale_h                    = model_config_rec % scale_h 
