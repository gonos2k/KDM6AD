...
! For HDF5 only
  ...
  integer, parameter :: WRF_GRIB2_ERR_READ              = -409
    ...
    INTEGER sf_urban_physics, w_damping, smooth_option, feedback, surface_input_source, sst_update, charnock_update 
...
wrf_err_message )
    ...
    call nl_get_charnock_update      ( 1      ,  charnock_update      ) 
    ...
    IF ( ( use_package( io_form ) == IO_NETCDF ) .OR. &
      ...
      CALL wrf_put_dom_ti_integer ( fid, 'CHARNOCK_UPDATE', charnock_update , 1 , ierr )   
