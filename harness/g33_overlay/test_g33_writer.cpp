...
int main(int argc, char** argv) {
    ...
    std::string header =
        ...
        "\"run_uuid\":\"uuid-c\",\"process_id\":\"1\",\"owner_thread_id\":\"1\",\"record_count_expected\":3}";
    Writer w(out, header);

    std::vector<uint8_t> p0; be_f32(p0, 1.0f); be_f32(p0, 2.5f); be_f32(p0, -3.25f);
    w.record("{\"seq_no\":0,\"outer_loop\":1,\"chain\":\"main\",\"n\":1,\"cell_role\":\"TOP\","
    ...
    w.record("{\"seq_no\":1,\"outer_loop\":1,\"chain\":\"main\",\"n\":1,\"cell_role\":\"TOP\","
    ...
    w.record("{\"seq_no\":2,\"outer_loop\":1,\"chain\":\"main\",\"n\":1,\"cell_role\":\"TOP\","
