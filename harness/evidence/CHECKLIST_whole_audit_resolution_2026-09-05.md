...
- Static overlay verification: all four source pins and macro-off text identity pass. This is not a non-invasiveness certificate; the actual G3.3 integration gate is recorded separately after the reviewed commit.
