...
| What inside the `rk_step_prep` bracket writes the `ww` difference, and why it appears at boundaries 59 and 176 but not 117 | OPEN | `FINDING_i_seam_first_write_is_rk_step_prep_v1` |
