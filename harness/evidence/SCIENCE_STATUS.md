...
| WHY advection produces them -- whether `qib` is outside the positive-definite limiter, or inside it and the limiter is insufficient for a paired moment | OPEN | `FINDING_invalid_qib_producer_v1` |
