...
| Whether the 76 differing field names Arm C produces at 60 s are a large or a small meteorological difference -- the count is the BREADTH of the effect, and this campaign has already shown for the MPI seam that a field count is not a magnitude. No RMS, percentile, LWP/IWP, precipitation or skill measure was taken | UNMEASURED | `FINDING_ccn_destroys_valid_input_v1` |
